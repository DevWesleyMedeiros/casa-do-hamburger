// O store agora guarda APENAS estado de UI puro
// Nada que vem do servidor vive aqui
// Se não houver mais estado de UI para o cart, pode deletar o arquivo
// export const useCartStore = create<CartStore>()(
//   devtools(() => ({}), { name: "CartStore" })
// );
